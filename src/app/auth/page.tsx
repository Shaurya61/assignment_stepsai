  ...
  return (
    <div className="min-h-screen flex items-center justify-center">
      <div className="max-w-md w-full mx-auto rounded-none md:rounded-2xl p-4 md:p-8 shadow-input bg-white dark:bg-black">
        ...
        <form className="my-8" onSubmit={(e) => { e.preventDefault(); handleAuth(); }}>
          {!isLogin && (
            <>
              <div className="flex justify-center mb-4">
                <button
                  ...
                  type="button"
                  className={`px-4 py-2 border ${isDoctor ? 'bg-indigo-600 text-white' : 'bg-white text-indigo-600'}`}
                >
                  Doctor
                </button>
                <button
              ...
              {isDoctor && (
                <LabelInputContainer className="mb-4">
                  ...
                  <Input id="specialty" placeholder="Specialty" type="text" value={specialty} onChange={(e) => setSpecialty(e.target.value)} />
                </LabelInputContainer>
              )}
            </>
          )}
          ...
          <div className="text-center mt-4">
            <button onClick={() => setIsLogin(!isLogin)} type="button" className="text-indigo-600 hover:text-indigo-500">
